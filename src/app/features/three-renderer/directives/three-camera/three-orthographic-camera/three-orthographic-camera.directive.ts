...
@Directive({
  ...
  providers: [{ provide: AbstractCamera, useExisting: forwardRef(() => ThreeOrthographicCameraDirective) }]
})
export class ThreeOrthographicCameraDirective  extends AbstractCamera<OrthographicCamera> implements AfterViewInit {
